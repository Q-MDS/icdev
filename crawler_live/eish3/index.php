...
$error_log = "<pre>";
$error_log .= " _____                       _                <br>";
$error_log .= "| ____|_ __ _ __ ___  _ __  | |    ___   __ _ <br>";
$error_log .= "|  _| | '__| '__/ _ \| '__| | |   / _ \ / _` |<br>";
$error_log .= "| |___| |  | | | (_) | |    | |__| (_) | (_| |<br>";
$error_log .= "|_____|_|  |_|  \___/|_|    |_____\___/ \__, |<br>";
$error_log .= "                                        |___/ <br>";
$error_log .= "</pre>";
$error_log .= "Date: " . date('Y-m-d H:i:s') . "<br><br>";
