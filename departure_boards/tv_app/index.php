			...
			else 
			{
				...
				switch(data.brand)
				{
					...
					case 'ZZ':
						...
						document.getElementById('arrivals').style.display = 'none';
						document.getElementById('ic').style.display = 'block';
						if (data.route_desc.trim().length > 37)
						{
							document.getElementById('ic_route_desc').style.fontSize = '0.7em';
						}
						else
						{
							document.getElementById('ic_route_desc').style.fontSize = '1em';
						}
					...
					case 'BI':
						...
						if (data.route_desc.trim().length > 37)
						{
							document.getElementById('bi_route_desc').style.fontSize = '0.7em';
						}
						else
						{
							document.getElementById('bi_route_desc').style.fontSize = '1em';
						}
