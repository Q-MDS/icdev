...
function get_layout()
{
	...
	else if ($brand_a == "IC" && $brand_b == "BI")
	{
		$screen_layout = 1;
	}
	else if ($brand_a == "BI" && $brand_b == "IC")
	{
		$screen_layout = 2;
	}
	else if ($brand_a == "IC" && $brand_b == "IC")
	{
		$screen_layout = 3;
	}
...
async function fetchSplitData()
{
	...
	if (navigator.onLine) 
	{
		...
		.then(result => 
		{
			...
			// const splitLeft = document.getElementById('split_left');
			// const splitright = document.getElementById('split_right');
